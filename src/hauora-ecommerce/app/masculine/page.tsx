...
const masculineProducts = [
  {
    id: 1,
    name: "Executive Steel Chain",
    subtitle: "Power & Precision",
    price: 399,
    originalPrice: 499,
    image: "/placeholder.svg?height=600&width=500&text=Executive+Steel+Chain",
    badge: "Bestseller",
    inStock: true,
    description: "Crafted from premium titanium steel with a bold, masculine design.",
    material: "steel",
    priceRange: "200-500",
    rating: 4.8,
    reviews: 124,
  },
  {
    ...
    badge: "Premium",
    inStock: true,
    description: "Handcrafted platinum links for the distinguished gentleman.",
    material: "platinum",
    priceRange: "500-1000",
    rating: 4.9,
    reviews: 89,
  ...
  {
    id: 3,
    name: "Carbon Fiber Band",
    subtitle: "Modern Edge",
    price: 249,
    image: "/placeholder.svg?height=600&width=500&text=Carbon+Fiber",
    badge: "New",
    inStock: true,
    description: "Lightweight carbon fiber with steel accents.",
    material: "steel",
    priceRange: "200-500",
    rating: 4.7,
    reviews: 67,
  },
  {
    ...
    price: 599,
    image: "/placeholder.svg?height=600&width=500&text=Gold+Chain",
    badge: "Limited",
    inStock: true,
    description: "18k gold chain with signature Hauora craftsmanship.",
    material: "gold",
    priceRange: "500-1000",
    rating: 4.9,
    reviews: 156,
  },
  {
    ...
    subtitle: "Rugged Elegance",
    price: 189,
    image: "/placeholder.svg?height=600&width=500&text=Leather+Wrap",
    badge: "Trending",
    inStock: false,
    description: "Premium leather with steel hardware.",
    material: "leather",
  ...
  },
  {
    ...
    price: 329,
    image: "/placeholder.svg?height=600&width=500&text=Titanium+Sport",
    badge: "Sport",
    inStock: true,
    description: "Lightweight titanium for active lifestyles.",
    material: "steel",
    priceRange: "200-500",
    rating: 4.8,
    reviews: 91,
...
export default function MasculinePage() {
  const [viewMode, setViewMode] = useState<"grid" | "list">("grid")
  const [sortBy, setSortBy] = useState("featured")
  const [selectedProduct, setSelectedProduct] = useState<(typeof masculineProducts)[0] | null>(null)
  ...
  const filteredAndSortedProducts = useMemo(() => {
    const filtered = masculineProducts.filter((product) => {
      // Search filter
      if (
        searchQuery &&
  ...
  const cartItemsArray = Object.entries(cartItems)
    .map(([id, quantity]) => {
      const product = masculineProducts.find((p) => p.id === Number.parseInt(id))
  ...
  const FilterContent = () => (
    <div className="space-y-6">
      ...
      {/* Materials */}
      <div className="space-y-3">
        <label className="text-sm font-light text-gray-700">Material</label>
        <div className="space-y-2">
          {["steel", "gold", "platinum", "leather"].map((material) => (
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 pt-24 lg:pt-28">
        {/* Mobile Search Bar */}
        <div className="md:hidden mb-6">
          <div className="relative">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 h-4 w-4" />
            <Input
              placeholder="Search masculine collection..."
              value={searchQuery}
        ...
        <div className="flex items-center space-x-2 text-sm font-light text-gray-600 mb-6">
          ...
          <span>/</span>
          <span className="text-black">Masculine</span>
        </div>
        ...
        <div className="mb-8 sm:mb-12">
          <div className="flex items-center space-x-3 mb-4 sm:mb-6">
            ...
            <span className="text-xs sm:text-sm font-light tracking-[0.3em] text-gray-600">MASCULINE</span>
          </div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-black mb-3 tracking-tight leading-tight">
            Power &<br />
            <span className="italic font-extralight">Precision</span>
          </h1>
          <p className="text-base sm:text-lg font-light text-gray-600 max-w-2xl">
            Bold statements for the modern gentleman. Discover our collection of sophisticated bracelets.
          </p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              <div className="flex items-center justify-between w-full sm:w-auto">
                <div className="text-sm font-light text-gray-600">
                  {filteredAndSortedProducts.length} of {masculineProducts.length} products
                </div>
